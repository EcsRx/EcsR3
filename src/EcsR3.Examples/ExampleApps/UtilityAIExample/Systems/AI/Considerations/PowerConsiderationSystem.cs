...
public class PowerConsiderationSystem : ConsiderationSystem<CharacterDataComponent>
{
    public override int ConsiderationId => ConsiderationTypes.Power;
    ...
    protected override ConsiderationKeyWithScore[] CalculateUtility(Entity entity, IConsiderationVariables considerationVariables, CharacterDataComponent characterComponent)
    {
        ...
        var damagePower = characterComponent.DamagePower;
        var score = CalculateScore(damagePower, entity, characterComponent);
