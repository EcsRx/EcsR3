...
namespace EcsR3.Systems.Batching.Convention.Multiplexing
{
    ...
    public abstract class MultiplexingBatchedRefSystem<T1, T2> : RawBatchedSystem<T1, T2> 
        where T1 : IComponent where T2 : IComponent
    {
        public IMultiplexedRefJob<T1, T2>[] Jobs { get; private set; }
        public ISystemPreProcessor[] PreProcessorJobs { get; private set; }
        public ISystemPostProcessor[] PostProcessorJobs { get; private set; }

        protected abstract IEnumerable<IMultiplexedRefJob<T1, T2>> ResolveJobs();
    ...
    public abstract class MultiplexingBatchedRefSystem<T1, T2, T3> : RawBatchedSystem<T1, T2, T3>
        where T1 : IComponent where T2 : IComponent where T3 : IComponent
    {
        public IMultiplexedRefJob<T1, T2, T3>[] Jobs { get; private set; }
        public ISystemPreProcessor[] PreProcessorJobs { get; private set; }
        public ISystemPostProcessor[] PostProcessorJobs { get; private set; }

        protected abstract IEnumerable<IMultiplexedRefJob<T1, T2, T3>> ResolveJobs();
    ...
    public abstract class MultiplexingBatchedRefSystem<T1, T2, T3, T4> : RawBatchedSystem<T1, T2, T3, T4>
        where T1 : IComponent where T2 : IComponent where T3 : IComponent where T4 : IComponent
    {
        public IMultiplexedRefJob<T1, T2, T3, T4>[] Jobs { get; private set; }
        public ISystemPreProcessor[] PreProcessorJobs { get; private set; }
        public ISystemPostProcessor[] PostProcessorJobs { get; private set; }

        protected abstract IEnumerable<IMultiplexedRefJob<T1, T2, T3, T4>> ResolveJobs();
    ...
    public abstract class MultiplexingBatchedRefSystem<T1, T2, T3, T4, T5> : RawBatchedSystem<T1, T2, T3, T4, T5>
        where T1 : IComponent where T2 : IComponent where T3 : IComponent where T4 : IComponent where T5 : IComponent
    {
        public IMultiplexedRefJob<T1, T2, T3, T4, T5>[] Jobs { get; private set; }
        public ISystemPreProcessor[] PreProcessorJobs { get; private set; }
        public ISystemPostProcessor[] PostProcessorJobs { get; private set; }

        protected abstract IEnumerable<IMultiplexedRefJob<T1, T2, T3, T4, T5>> ResolveJobs();
    ...
    public abstract class MultiplexingBatchedRefSystem<T1, T2, T3, T4, T5, T6> : RawBatchedSystem<T1, T2, T3, T4, T5, T6>
        where T1 : IComponent where T2 : IComponent where T3 : IComponent where T4 : IComponent where T5 : IComponent where T6 : IComponent
    {
        public IMultiplexedRefJob<T1, T2, T3, T4, T5, T6>[] Jobs { get; private set; }
        public ISystemPreProcessor[] PreProcessorJobs { get; private set; }
        public ISystemPostProcessor[] PostProcessorJobs { get; private set; }

        protected abstract IEnumerable<IMultiplexedRefJob<T1, T2, T3, T4, T5, T6>> ResolveJobs();
    ...
    public abstract class MultiplexingBatchedRefSystem<T1, T2, T3, T4, T5, T6, T7> : RawBatchedSystem<T1, T2, T3, T4, T5, T6, T7>
    ...
    {
        public IMultiplexedRefJob<T1, T2, T3, T4, T5, T6, T7>[] Jobs { get; private set; }
        public ISystemPreProcessor[] PreProcessorJobs { get; private set; }
        public ISystemPostProcessor[] PostProcessorJobs { get; private set; }

        protected abstract IEnumerable<IMultiplexedRefJob<T1, T2, T3, T4, T5, T6, T7>> ResolveJobs();
